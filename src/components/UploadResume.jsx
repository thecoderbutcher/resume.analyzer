  ...
  return (
    <Card>
      <div className="flex flex-col justify-center items-center w-[500px] p-8 border-2 border-dashed border-slate-600 rounded-xl gap-2">
        ...
        <button className="p-2 font-semibold bg-gradient-to-b from-sky-400 via-sky-600 to-sky-800 rounded-lg shadow-lg hover:shadow-cyan-600 transition-all duration-300">
          Choose PDF File
        </button>
      </div>
    </Card>
